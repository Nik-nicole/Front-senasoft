	...
	<div className="grid max-w-screen-xl px-4 pt-20 pb-8 mx-auto lg:gap-8 xl:gap-0 lg:py-16 lg:grid-cols-12 lg:pt-28">
		<div className="mr-auto place-self-center lg:col-span-7">
			<h1
				...
				<p className="max-w-2xl mb-6 font-light text-gray-500 lg:mb-8 md:text-lg lg:text-xl dark:text-gray-400" />Aqui podras encontrar varias opciones para mejorar la eficacia a la hora de organizar tus proyectos y ademas de mejorar tiempos de entrega de los mismos <br />
				<div className="space-y-4 sm:flex sm:space-y-0 sm:space-x-4 mt-5">
          <br />
					<Link href="" target="_blank"
						className="inline-flex items-center justify-center mt-3 w-full px-5 py-3 text-sm font-medium text-center text-white bg-green-600 border border-transparent rounded-lg sm:w-auto hover:bg-green-700 focus:ring-4 focus:ring-green-300 dark:focus:ring-green-800">
						 Sing In 
					</Link>
					<Link href="" target="_blank"
	...
	<div className="max-w-screen-xl px-4 py-8 mx-auto space-y-12 lg:space-y-20 lg:py-24 lg:px-6">
		...
		<div className="items-center gap-8 lg:grid lg:grid-cols-2 xl:gap-16">
			<div className="text-gray-500 sm:text-lg dark:text-gray-400">
				<h2 className="mb-4 text-3xl font-extrabold tracking-tight text-gray-900 dark:text-white">Work with tools
					you already use</h2>
				...
				<ul role="list" className="pt-8 space-y-5 border-t border-gray-200 my-7 dark:border-gray-700">
					<li className="flex space-x-3">
						...
						<svg className="flex-shrink-0 w-5 h-5 text-links dark:text-purple-400" fill="currentColor"
...
<section className="bg-white dark:bg-gray-900">
	<div
		...
		<div className="col-span-2 mb-8">
			<p className="text-lg font-medium text-links dark:text-purple-500">Trusted Worldwide</p>
			...
			<div className="pt-6 mt-6 space-y-4 border-t border-gray-200 dark:border-gray-700">
				<div>
					<a href="#"
						className="inline-flex items-center text-base font-medium text-links hover:text-links dark:text-purple-500 dark:hover:text-purple-700">
				...
				<div>
					<a href="#"
						className="inline-flex items-center text-base font-medium text-links hover:text-links dark:text-links dark:hover:text-purple-700">
		...
		<div className="col-span-2 space-y-8 md:grid md:grid-cols-2 md:gap-12 md:space-y-0">
			<div>
				<svg className="w-10 h-10 mb-2 text-links md:w-12 md:h-12 dark:text-lionsk" fill="currentColor"
					viewBox="0 0 20 20" xmlns="http://www.w3.org/2000/svg">
					<path fillRule="evenodd"
			...
			<div>
				<svg className="w-10 h-10 mb-2 text-links md:w-12 md:h-12 dark:text-links" fill="currentColor"
					viewBox="0 0 20 20" xmlns="http://www.w3.org/2000/svg">
					<path
...
<section className="bg-gray-50 dark:bg-gray-800">
	<div className="max-w-screen-xl px-4 py-8 mx-auto text-center lg:py-24 lg:px-6">
		<figure className="max-w-screen-md mx-auto">
			...
			<blockquote>
				<p className="text-xl font-medium text-gray-900 md:text-2xl dark:text-white">Landwind is just awesome. It
...
<section className="bg-white dark:bg-gray-900">
	<div className="max-w-screen-xl px-4 py-8 mx-auto lg:py-24 lg:px-6">
		<div className="max-w-screen-md mx-auto mb-8 text-center lg:mb-12">
			<h2 className="mb-4 text-3xl font-extrabold tracking-tight text-gray-900 dark:text-white">Designed for business
				teams like yours</h2>
			<p className="mb-5 font-light text-gray-500 sm:text-xl dark:text-gray-400">Here at Landwind we focus on markets
		...
		<div className="space-y-8 lg:grid lg:grid-cols-3 sm:gap-6 xl:gap-10 lg:space-y-0">
			...
			<div
				...
				<a href="#"
					className="text-white bg-links hover:bg-links focus:ring-4 focus:ring-links font-medium rounded-lg text-sm px-5 py-2.5 text-center dark:text-white  dark:focus:ring-purple-900">Get
					started</a>
			</div>
			...
			<div
				...
				<p className="font-light text-gray-500 sm:text-lg dark:text-gray-400">Relevant for multiple users, extended
					& premium support.</p>
				<div className="flex items-baseline justify-center my-8">
				...
				<a href="#"
					className="text-white bg-links hover:bg-links focus:ring-4 focus:ring-purple-200 font-medium rounded-lg text-sm px-5 py-2.5 text-center dark:text-white  dark:focus:ring-purple-900">Get
					started</a>
			</div>
			...
			<div
				...
				<p className="font-light text-gray-500 sm:text-lg dark:text-gray-400">Best for large scale uses and extended
		...
		<div className="max-w-screen-md mx-auto">
			<div id="accordion-flush" data-accordion="collapse"
				...
				<h3 id="accordion-flush-heading-1">
					...
					<Menu.Button type="button" class="flex items-center justify-between w-full py-5 font-medium text-left text-gray-900 bg-white border-b border-gray-200 dark:border-gray-700 dark:bg-gray-900 dark:text-white" data-accordion-target="#accordion-flush-body-1" aria-expanded="true" aria-controls="accordion-flush-body-1">
<span>¿Qué tipo de proyectos manejan?</span>
        ...
        <Menu.Item>
					<div className="py-5 border-b border-gray-200 dark:border-gray-700">
						...
						<p className="text-gray-500 dark:text-gray-400">Check out this guide to learn how to <a href="#"
								className="text-links dark:text-purple-500 hover:underline">get started</a> and start
...
<span>¿Cómo se estructura el proceso de gestión de proyectos?</span>
...
<span>¿Cuál es el rol del cliente durante el proyecto?</span>
<svg data-accordion-icon="" className="w-6 h-6 shrink-0" fill="currentColor" viewBox="0 0 20 20" xmlns="http://www.w3.org/2000/svg"><path fillRule="evenodd" d="M5.293 7.293a1 1 0 011.414 0L10 10.586l3.293-3.293a1 1 0 111.414 1.414l-4 4a1 1 0 01-1.414 0l-4-4a1 1 0 010-1.414z" clipRule="evenodd"></path></svg>
</button>
				</h3>
				<div id="accordion-flush-body-3" className="hidden" aria-labelledby="accordion-flush-heading-3">
					<div className="py-5 border-b border-gray-200 dark:border-gray-700">
						...
						<ul className="pl-5 text-gray-500 list-disc dark:text-gray-400">
							<li><a href="#" className="text-links dark:text-links hover:underline">Landwind
									Pro</a></li>
							<li><a href="#" className="text-links dark:text-links hover:underline">Tailwind UI</a>
							</li>
						</ul>
					</div>
				</div>
...
<span>¿Cómo manejan los cambios en los requisitos del proyecto?</span>
<svg data-accordion-icon="" className="w-6 h-6 shrink-0" fill="currentColor" viewBox="0 0 20 20" xmlns="http://www.w3.org/2000/svg"><path fillRule="evenodd" d="M5.293 7.293a1 1 0 011.414 0L10 10.586l3.293-3.293a1 1 0 111.414 1.414l-4 4a1 1 0 01-1.414 0l-4-4a1 1 0 010-1.414z" clipRule="evenodd"></path></svg>
</button>
				</h3>
...
<section className="bg-gray-50 dark:bg-gray-800">
	<div className="max-w-screen-xl px-4 py-8 mx-auto lg:py-16 lg:px-6">
		<div className="max-w-screen-sm mx-auto text-center">
			<h2 className="mb-4 text-3xl font-extrabold leading-tight tracking-tight text-gray-900 dark:text-white">Start
				your free trial today</h2>
			<p className="mb-6 font-light text-gray-500 dark:text-gray-400 md:text-lg">Try Landwind Platform for 30 days. No
				credit card required.</p>
			<a href="#"
				className="text-white bg-links hover:bg-links focus:ring-4 focus:ring-purple-300 font-medium rounded-lg text-sm px-5 py-2.5 mr-2 mb-2 dark:bg-purple-600 dark:hover:bg-purple-700 focus:outline-none dark:focus:ring-purple-800">Free
				trial for 30 days</a>
		</div>
	</div>
</section>
	...
	<div className="max-w-screen-xl p-4 py-6 mx-auto lg:py-16 md:p-8 lg:p-10">
		...
		<div className="text-center">
			<a href="#"
				...
				<span className="block text-sm text-center text-gray-500 dark:text-gray-400">© 2024 iKernel™. Todos lo derechos reservados.
</span>

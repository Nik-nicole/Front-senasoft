...
import carnei from '../assets/carnei.jpg' // Ajusta la ruta según donde guardes el servicio
                            ...
                            <table className="w-full text-sm text-left text-gray-500 dark:text-gray-400">
                                ...
                                <tbody>
                                    {Array.isArray(products) && products.map(product => (
                                        <tr key={product.id}>
                                            <td className="px-4 py-2">{product.carnei}</td>
                                            <td className="px-4 py-2">{product.nameProducto}</td>
